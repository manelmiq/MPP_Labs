...
//        1)Count the number of last names that begin with the letter ‘B’.Print out this number.
        System.out.println("Count the number os employee that last name that start with  B");
...
//        2)Print out all of the Employee objects whose last name begins with the letter ‘B’in sorted order.
        System.out.println("Numbers of the last name that starts with B");
        list.stream()
                .filter(lastNameB)
...
//        name and last name to be All capital letters.
        System.out.println("3 Number os the last name that starts with B and change the last and first name");
        list.stream()
                .filter(lastNameB)
                .map(s -> {
//                    Employee employee = new Employee();
                ...
                .forEach(System.out::println);
//        4)Print out All of the employee objects, but if the last name begins with the letter ‘B’,then capitalize all the
...
//        Do_Last_This_Was_Lesson 9_ Streams_E.docx’.)
...
//        4.2)Use the Collectors.joining method to print out All Employee objects, and separate each one with a delimeter
//        of “---\n-- -“.(See my presentation file ‘Do_Last_This_Was_Lesson 9_ Streams_E.docx’.)
